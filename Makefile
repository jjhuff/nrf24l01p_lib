...
CDEFS = -DF_CPU=$(F_CPU)UL #-DSOFTUART_INVERTED
...
AVRDUDE_FUSE_LOW = 0xef
AVRDUDE_FUSE_HIGH = 0xd6
...
# Program the device.  
burn: $(TARGET).hex $(TARGET).eep size
